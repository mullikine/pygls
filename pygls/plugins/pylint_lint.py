...
class PylintLinter(object):
    ...
    def lint(cls, document, is_saved, flags=''):
        ...
        for diag in json.loads(json_out):
            # pylint lines index from 1, pygls lines index from 0
            line = diag['line'] - 1
...
@hookimpl
def pygls_lint(config, document, is_saved):
    """Run pylint linter."""
...
def pylint_lint_stdin(pylint_executable, document, flags):
    ...
    :type document: pygls.workspace.Document
